...
<script type="text/javascript">
			...
			if(result.length < 1){
				htmls = "등록된 댓글이 없습니다";
	                    ...
	                    $(result).each(function(){
	                     ...
	                     htmls += '<div class="comment-list" style="background-color: #f8f9fa">';
	                     ...
	                     htmls += '<div class="d-flex align-items-center"><h5><a href="#" style="font-size: 12.5px">' + this.rp_writer + '</a></h5>';
	                     htmls += '</div>';
	                     htmls += '</div>';
	                     htmls += '<p class="d-flex" style="font-size: 16px">';
	                     htmls += this.rp_content;
	                     htmls += '</p>';
	                     htmls += '<p class="date" style="padding-right: 30px; display: inline">' + this.rp_reg + '</p>';
	                     htmls += '<a href="javascript:void(0)" onclick="fn_editReply(' + this.rp_id + ', \'' + this.rp_writer + '\', \'' + this.rp_content + '\', \'' + this.rp_reg + '\' )" style="color: #10285d; font-size: 16px; margin: 3px">edit</a>';
	                     htmls += '<a href="javascript:void(0)" onclick="fn_deleteReply(' + this.rp_id + ')" style="color: #10285d; font-size: 16px; margin: 3px" >del</a>';
	                     htmls += '</div>';
	                     htmls += '</div>';
	                     htmls += '</div>';
	                     htmls += '</div>';
	...
	function fn_editReply(rp_id, rp_writer, rp_content, rp_reg){
        ...
        htmls += '<div class="desc">';
        htmls += '<div class="d-flex justify-content-between">';
        htmls += '<div class="d-flex align-items-center"><h5><a href="#" style="font-size: 12.5px">' + rp_writer + '</a></h5>';
        htmls += '</div>';
        htmls += '</div>';
        htmls += '<textarea name="editContent" id="editContent" class="form-control" rows="3">';
        htmls += rp_content;
        htmls += '</textarea>';
        htmls += '<p class="date">' + rp_reg + '</p>';
